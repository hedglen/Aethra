...
The format follows Keep a Changelog, and releases are versioned with SemVer.
...
- Project guidance aligned to GPL-2.0-or-later repo licensing, LGPL-first default public native-runtime posture, x64-first support, and unpackaged-first with optional MSIX-capable packaging.
